...
|---|---|
| `/blob/bafy/0\n0\n\n` | `wCA9mV5qAnke18Afc_IC_w0JGX3GbaCrCtxx6QX6gng` |
| `/i/bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi/p/thumb.webp\n1730000000\nhttps://example.com\nk_2026_05` | `Z5PRGs6i6Jwykx_rbS3eB1lKKTP_VvtUbknTiW6b2Es` |
| `/blob/bafybeigexamplecidvalue\n2000000000\nhttps://app.example\nk_test` | `O93GFW_mH_5EYXYyF91c4-Wu7sSIZCggZ46a0_RrZpY` |

(The authoritative fixture is `internal/auth/signedurl/testdata/vectors.txt`,
generated independently of the implementation; `signedurl_test.go`'s
`TestVectors` asserts `Sign` reproduces each row.)
